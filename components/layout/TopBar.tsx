...
export default function TopBar() {
    ...
    return (
        <div className="bg-gradient-to-r from-orange-500 via-orange-400 to-orange-500 text-white text-xs">
            <div className="max-w-[2800px] mx-auto px-4 py-1">
                <div className="flex items-center justify-between">
                    {/* Left: Government Links with Hindi */}
                    <div className="flex items-center gap-4">
                        ...
                        >
                            <div className="flex flex-col leading-tight">
                                ...
                                <span className="text-[10px] opacity-90">Government of India</span>
                            </div>
                        </a>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <a
                            href="#main-content"
                            className="hover:text-white/80 transition-colors uppercase tracking-wide text-[10px] font-medium hidden sm:inline"
                        >
                        ...
                        <div className="flex items-center gap-0.5">
                            <button
                                ...
                                className="px-1.5 py-0.5 hover:bg-white/20 rounded transition-colors font-bold"
